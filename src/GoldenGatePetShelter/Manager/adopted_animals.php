<?php
	...
	$query = "SELECT * FROM Animals INNER JOIN Adopted ON Animals.ID=Adopted.Animal_ID";

	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		$_SESSION['aid'] = $_POST['info'];
		header('location: adopter_info.php');
	}
	    ...
	    <nav class="site-header sticky-top py-1 navbar-dark bg-dark">
	     ...
	     <hr>
	        ...
	        <div class="col-md-0 p-lg-10 mx-auto my-5">
			 ...
			 <h2 style="text-align:center;margin-bottom:20px">Adopted Animals</h2>
...
<?php 
	...
	<th> <font face="Arial" size="5em">Adopter Info</font></th>
	</tr>';
